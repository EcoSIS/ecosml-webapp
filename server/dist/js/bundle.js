...
<div class="main-panel">
  ...
  ${this.data.history.map((e,t)=>L`
    <tr ?even="${t%2==0}">
      <td>
        ${e.admin||this.data.requestedBy}
        ${e.requestedByEmail||""}
      </td>
      <td>${e.state}</td>
      <td>${new Date(e.timestamp).toISOString().replace(/T.*/,"")}</td>
    </tr>
